...
const Update = ({ setOpenUpdate, user, updateUser }) => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      // On success, update the currentUser in the context
      updateUser(data);  // Update the global context with new user data
  ...
  const handleClick = async (e) => {
    ...
    // Reset state and close the modal after successful update
    setOpenUpdate(false);
    setCover(null);
    setProfile(null);
  };
